...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        const [result] = await pool.query(
            `SELECT L_ListingID AS ListingID, L_City AS City, L_State AS State, L_Address AS Address, L_Zip AS Zipcode, L_SystemPrice AS Price, L_Keyword2 AS Beds, LM_Dec_3 AS Baths, LM_Int2_3 AS SQFT, L_Photos as Photos 
